"""
Module with code specific for blog application.
"""
import time
...
from pisak.libs.blog import widgets, wordpress, config, html_parsers, rest_client
...
import pisak.libs.viewer.model  # @UnusedImport
import pisak.libs.blog.widgets  # @UnusedImport
import pisak.libs.blog.handlers  # @UnusedImport
...
def prepare_viewer_album_view(app, window, script, data):
    library = pisak.viewer.model.get_library()
