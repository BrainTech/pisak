...
"""
HOME_SYMBOLS_MODEL = os.path.join(HOME_SYMBOLS_DIR, "symbols_model.ini")

"""
Path to the symbols entries file generated by "symboler" application.
"""
HOME_SYMBOLS_ENTRY = os.path.join(HOME_SYMBOLS_DIR, "symbols_entry.ini")
...
"""
HOME_TEXT_DOCUMENTS_DB = os.path.join(HOME_PISAK_DIR,'documents.db')
